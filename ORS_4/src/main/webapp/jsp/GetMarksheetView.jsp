   ...
   <form action="<%=ORSView.GET_MARKSHEET_CTL%>" method="post">
    ...
    <center>
        <div align="center">
            ...
            <table>
            <!--label style="color:orange "># Enter Roll No in Formate [00EC0000]</label>-->
            <br>
				<tr><th align="right"> Roll No <span style="color:red">*</span></th>
				<td><input type="text" name="rollNo" placeholder="00EC0000" size="25" value="<%=ServletUtility.getParameter("rollNo", request)%>">
